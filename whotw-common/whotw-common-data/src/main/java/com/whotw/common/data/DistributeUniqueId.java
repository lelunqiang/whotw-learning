 ...
 * @version 3.0
 */
public final class DistributeUniqueId {

    private static final Logger logger = getLogger(DistributeUniqueId.class);
    ...
    public DistributeUniqueId(){
        this(null, null, null, null, null);
    }

    public DistributeUniqueId(long dataCenterId) {
        this(dataCenterId, null, false, 5L, false);
    }

    public DistributeUniqueId(long dataCenterId, boolean clock, boolean randomSequence) {
        this(dataCenterId, null, clock, 5L, randomSequence);
    }
     ...
     */
    public DistributeUniqueId(Long dataCenterId, Long workerId, Boolean clock, Long timeOffset, Boolean randomSequence) {
        if(dataCenterId==null)
            this.dataCenterId = generateDatacenterId(MAX_DATA_CENTER_ID);
        else{
        ...
        if(workerId==null)
            this.workerId = generateWorkerId(this.dataCenterId, MAX_WORKER_ID);
        else {
        ...
        this.clock = clock==null?false:clock.booleanValue();
        this.timeOffset = timeOffset==null?5L:timeOffset;
        this.randomSequence = randomSequence==null?false:randomSequence.booleanValue();
    }
     ...
     * 获取 maxWorkerId
     */
    protected static long generateWorkerId(long datacenterId, long maxWorkerId) {
     ...
     * 数据标识id部分
     */
    protected static long generateDatacenterId(long maxDatacenterId) {
        long id = 0L;
        try {
